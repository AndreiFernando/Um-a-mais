    ...
    <input type="hidden" name="id_client" value="<?=$_GET["client"]?>">
      ...
      <div class="sangues">
        <div class="linha1">
         ...
         <p class="nomeUser"><?php echo"Olá, ".$_SESSION["NOME_USUARIO"]."!"?>;</p>
          <p class="pontos1">1.500</p>
          <i class='got fas fa-droplet'></i>
        </div>
        <div class="linha2">
          <i class='hist fas fa-thin fa-clipboard-list'></i>
          <p class="nomeUser"> <a href="historicodoacao.php">Historico de doações</a></p>
        </div>
        <div class="linha3">
          <i class='favorite fas fa-sharp fa-solid fa-star'></i>
          <p class="nomeUser"> <a href="hemocentrofavorito.php">Hemocentro Favorito</a></p>
        </div>
        <div class="linha4">
          <i class="market fas fa-duotone fa-store"></i>
          <p class="nomeUser"> <a href="parceiros.php">Lojinha Um A+</a></p>
        </div>
        <div class="linha5">
          <i class="dadospessoais fas fa-regular fa-id-card"></i>
          <p class="nomeUser">Dados Pessoais</p>
        </div>
        <div class="linha6">
          <i class="configuracoes fas sfa-regular fa-house-medical-flag"></i>
          <p class="nomeUser"><a href="hemocentros.php">Hemocentro</a></p>
        </div>
