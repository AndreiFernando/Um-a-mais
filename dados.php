...
<body>
  ...
  <header>
    <main class="corpo">
      <br>
      <h2>Cadastre-se</h2>
      <h3>Bem vindo ao Um A+ !!!</h3>
      <h3>Para continuar, preencha com seus dados pessoais</h3>

      <form class="CampoNome forms" method="post" action="inserir-dados.php">
        <fieldset class="nome">
          <legend>Nome </legend>
          <Input class="cadastro" type="text" id="Nome Completo" name="nome" required placeholder=" Digite o seu Nome">
        </fieldset>
        <fieldset class="nome">
          <legend>Sobrenome</legend>
          <Input class="cadastro" type="text" id="Nome Completo" name="sobrenome" required placeholder=" Digite o seu sobrenome">
        </fieldset>
        <legend>Data de nascimento</legend>
        <Input class="cadastro" type="date" id="Nome Completo" name="dataNasc" required>
        </fieldset>
        <fieldset class="nome">
        ...
        <button class="validarcadastro">Continue</button>
      </form>



      <section id="text">
        <h4>Torne sua senha mais segura:</h4>
        <p>Use mais de 8 digitos;</p>
        <p>Combine letras Maiúsculas,Minusculas e Números.</p>
        <p>Não use Informações Pessoais.</p>

      </section>

      <h3>Já tem uma conta? <a href="acesso.html">Clique aqui para entrar.</a></h3>
      <br>
    </main>
  </header>
